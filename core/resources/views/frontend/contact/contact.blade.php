                            ...
                            <div class="col-sm-12 col-md-6">
                                <form class="form-horizontal" role="form" method="post" action="">
                                    ...
                                    <div class="form-group has-float-label">
                                        <input id="name" class="form-control" name="name" placeholder="Name" value="" type="text">
                                        <label for="name">Name</label>
                                    </div>
                                    <div class="form-group has-float-label">
                                        <input id="email" class="form-control" oninput="emailCheck(this.value)" name="email" placeholder="Email" value="" type="email">
                                        <label for="email">Email</label>
                                    </div>
                                    <div class="form-group has-float-label">
                                        <input id="phone" class="form-control" name="phone" oninput="phoneCheck(this.value)" placeholder="Phone" value="" type="number">
                                    ...
                                    <div class="form-group textarea_group">
                                        ...
                                        <div class="inputGroupContainer">
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control border-group" name="message" rows="3" cols="6" placeholder="Type your message here."></textarea>
                                            </div>
                                        </div>
                                    </div>
