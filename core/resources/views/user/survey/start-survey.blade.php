                        ...
                        <form action="{{ route('submit.survey') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-2">
                                    <div class="card">
                                        <div class="container mt-1 mb-1">
                                            <label class="control-label">New or Old Patient <span class="text-danger">*</span></label>
                                            <div class="d-flex">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="patient" onclick="getNewPatient()" value="1" id="patient1" checked>
                                                    <label class="form-check-label" for="patient1">
                                                        New Patient
                                                    </label>
                                                </div>
                                                <div class="form-check ml-4">
                                                    <input class="form-check-input" type="radio" name="patient" onclick="getOldPatient()" value="2" id="patient2">
                                ...
                                <div class="col-sm-6 mb-2 appendField2" style="display: none">
                                    ...
                                    <select name="unique_id" class="form-control select2" style="width: 100%">
                                ...
                                <div class="container appendField">
                                    <div class="row">
                                        <div class="col-sm-6 mb-2">
