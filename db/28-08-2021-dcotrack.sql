...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 28, 2021 at 07:46 AM
...
CREATE TABLE `admins` (
  ...
  `user_role` bigint(20) DEFAULT NULL COMMENT '1=admin, 2=manager, 10=superadmin',
...
INSERT INTO `admins` (`id`, `upazilla_id`, `union_id`, `user_role`, `category_id`, `first_name`, `last_name`, `phone`, `image`, `profession`, `address`, `email`, `email_verified_at`, `password`, `status`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, NULL, NULL, 1, NULL, 'Admin', NULL, NULL, NULL, NULL, NULL, '', NULL, '$2y$10$oxdZxPuLd0GRr7ZUsfci1OGMa3Prk4pYrV2w79JfxT2emf/Oz5hqK', 1, NULL, NULL, NULL),
(2, 395, NULL, 2, 2, 'Trinath Saha', NULL, '01621355844', 'assets/backend/images/user/jTHSaLgBvTgOgglZftOGZc6FTue6Co81wZBgyuvm.png', 'Web Developer', 'Mirpur', 'trinath@gmail.com', NULL, '$2y$10$nMboTaZpgp15j0S2maGd8upB9DmCcJz8ROAzeA/ze/20IQLLbBzbW', 1, NULL, '2021-07-14 06:38:50', '2021-07-14 06:38:50'),
(3, NULL, NULL, 10, NULL, 'Super Admin', NULL, NULL, NULL, NULL, NULL, 'superadmin@gmail.com', NULL, '$2y$12$YqMawxDyCW.weH7wGm6d/./jVS2T7fQ4HnMD7kQIPl0CySwnBnuo.', 1, NULL, NULL, NULL),
(4, 44, NULL, 2, 4, 'Pabel', NULL, '01621355842', NULL, 'Web Developer', 'Mohammadpur', 'bondhupabel@gmail.com', NULL, '$2y$10$/xAdjLOBP1p7MV1b8/xJc.Rt9l9bR.9YYn2uEaJ8puEFkAyvz4ZMa', 1, NULL, '2021-07-27 06:05:20', '2021-08-24 12:02:59'),
(5, 197, NULL, 2, 2, 'Zakir Khan', NULL, '01681014428', 'assets/backend/images/user/olWhdRFfnr5AizIBo3qRLi4f5dLNQxJRH8w19Snx.jpg', 'Student', 'Mirpur 2', 'zakirkhan4428@gmail.com', NULL, '$2y$10$Dpu1rZTRwXcKduNZlG2pa.rM.kGSoBMDlYaq7qtOj7g.sU1Ti8mdi', 1, NULL, '2021-08-24 10:48:09', '2021-08-24 12:03:13');
...
(14, 23, '2021-08-24 09:03:43', NULL, '2021-08-24 09:03:43', '2021-08-24 09:03:43'),
(15, 18, '2021-08-25 06:16:28', '2021-08-25 06:25:54', '2021-08-25 06:16:28', '2021-08-25 06:25:54'),
(16, 27, '2021-08-25 06:26:05', '2021-08-25 06:27:11', '2021-08-25 06:26:05', '2021-08-25 06:27:11'),
(17, 18, '2021-08-25 11:20:16', NULL, '2021-08-25 11:20:16', '2021-08-25 11:20:16'),
(18, 18, '2021-08-26 06:20:03', '2021-08-26 07:02:53', '2021-08-26 06:20:03', '2021-08-26 07:02:53'),
(19, 27, '2021-08-26 07:03:01', NULL, '2021-08-26 07:03:01', '2021-08-26 07:03:01');
...
INSERT INTO `questions` (`id`, `category_id`, `type`, `name`, `status`, `position`, `created_at`, `updated_at`) VALUES
(2, 4, 2, 'What are the products required?', 1, 2, '2021-05-29 10:58:00', '2021-08-25 09:44:27'),
(5, 4, 1, 'What is Computer?', 1, 7, '2021-06-15 12:53:42', '2021-08-25 09:44:03'),
(7, 4, 3, 'Connectionless protocol?', 1, 6, '2021-06-17 20:03:27', '2021-08-25 09:43:29'),
(8, 4, 4, 'Next branch locations?', 1, 5, '2021-06-17 20:04:50', '2021-08-25 09:42:59'),
(9, 4, 4, 'Products coming from', 1, 4, '2021-06-19 14:18:50', '2021-08-25 09:42:50'),
(10, 4, 3, 'Select desired item', 1, 3, '2021-06-22 16:00:42', '2021-08-25 09:41:59'),
(11, 4, 2, 'Mention the name of the seller', 1, 8, '2021-06-30 17:13:31', '2021-08-25 09:45:46'),
(12, 4, 1, 'Most sold product', 1, 1, '2021-06-30 17:15:09', '2021-08-25 11:05:40');
...
CREATE TABLE `users` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `category_id` int(11) DEFAULT NULL,
  `role_id` int(11) NOT NULL DEFAULT 1 COMMENT '1=Researcher, 2=volunteer, 3=Fieldworker, 4=Salesman, 5=Data collector',
  `first_name` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_name` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phone` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `profession` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(27, 2, 3, 'Khan', 'Zakir', '01681014428', NULL, '1', 14, 130, NULL, 'rampura', 'assets/backend/images/user/8a7Y5KckU9KvUbrk2VmOmKsn459kEdOXKUMchGsM.png', 'khanzakir@gmail.com', NULL, '$2y$10$NQELEmW6.9JKcFYWkkCav.oqBb0qJ8fbJYQ2YVYOAQLnZFhoSS.uW', 1, NULL, '2021-08-25 06:25:10', '2021-08-26 07:46:07');
...
(16, 23, NULL, NULL, NULL, '23.7644', '90.4286', '2021-08-24 09:10:46', '2021-08-24 09:10:46');
